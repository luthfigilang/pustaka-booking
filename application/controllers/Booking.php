...
class Booking extends CI_Controller
{
    ...
    public function riwayat() {
        ...
        $data['riwayat'] = $this->db->query("select * from pinjam p,detail_pinjam d,
          buku b,user u where d.id_buku=b.id and p.id_user=u.id
          and p.no_pinjam=d.no_pinjam and u.email='$email'")->result_array();        
        
        $data['judul'] = "Riwayat Pemesanan";

        $this->load->view('templates/templates-user/header', $data);
        $this->load->view('booking/riwayat-booking', $data);
        $this->load->view('templates/templates-user/modal');
        $this->load->view('templates/templates-user/footer');        
    }
}
